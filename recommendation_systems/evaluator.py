...
class RecommenderEvaluator:
    def __init__(self, recommender, recs_df, all_items):
        """
        Args:
    ...
    def cacluclate_coverage(self, all_recommendations):
